...
const Subentri = () => {
  ...
  return (
    <section id="autoletture" className="w-full h-screen flex items-center justify-center bg-black m-auto">
      <div className="grid md:grid-cols-2 mx-auto max-w-[1240px] items-center justify-center m-auto">
        <h1 className='text-cyan-400 font-sans font-bold text-4xl p-6 m-auto mt-6'>AUTOLETTURA</h1>
        {emailSubmitted ? (
