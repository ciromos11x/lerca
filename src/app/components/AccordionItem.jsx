...
export default function AccordionItem() {
  return (
    <div id='servizi' className=' items-center  justify-center font-sans   bg-black'>
      ...
      <div className='t max-w-[1240px] place-items-center  mx-auto border-slate-300 rounded-xl  shadow-xl p-12 '>
        
    <Accordion className='bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 mb-2 p-2'>

      <AccordionSummary expandIcon={<ExpandMoreIcon />}
      aria-controls="panel1a-content"
      id="panel1a-header"
      >
        <Typography className='text-white text-xl font-bold'>Abiti in un Condominio?</Typography>
      </AccordionSummary>
      <AccordionDetails>
    ...
    <Accordion className='bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 mb-2 p-2'>
      ...
      <AccordionSummary expandIcon={<ExpandMoreIcon />}
       ...
       id="panel2a-header">
        <Typography className='text-white text-xl font-bold'>Come Avvalersi Dei Nostri Servizi</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <Typography className='text-white text-md'>
    ...
    <Accordion className='bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 mb-2 p-2'>
      ...
      id="panel3a-header">
        <Typography className='text-white text-xl font-bold'>Descrizione modalità d&apos;intervento</Typography>
      </AccordionSummary>
      <AccordionDetails>
        <Typography className='text-white text-md'>
