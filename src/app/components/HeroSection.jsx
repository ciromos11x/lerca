...
const Hero = () => {
  return (
    <div name='home' className='w-full h-screen  bg-gradient-to-b from-zinc-400 via-zinc-200 to-zinc-400 m-auto border-slate-300  flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] bg-gradient-to-b from-zinc-300 via-zinc-200 to-zinc-300 m-auto border-slate-300 rounded-xl  shadow-xl p-12 '>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                <p className='text-2xl'>Lettura & Riparazioni Contatori Acqua</p>
